...
<head>
    ...
    <title>BananaLeaf | Reservation</title>
...
<body>
    ...
    <div id="home">
      <nav class="navbar navbar-expand-lg px-5 pt-4">
        <a class="navbar-brand" href="#">BANANA LEAF</a>
    ...
    <form class="box" method="post"><br><br><br><br>
  <h1>Reservation</h1>
  ...
  <input type="number" name="no_people" placeholder="Number of people" required="">
